...
(
	...
	pe.entry_point == 0xA3A8 or //2.52
	pe.entry_point == 0xA53F or //2.00
	pe.entry_point == 0x2AB19 or //3.70a
	...
	pe.entry_point == 0x41733 or  //4.30xx
	pe.entry_point == 0x44000 or  //4.30
	pe.entry_point == 0x43000 or  //4.40
	pe.entry_point == 0x3AE97 or  //4.66 dll
	pe.entry_point == 0x42000 or  //4.42
	pe.entry_point == 0xE6C0A or  //5.0 dll
	pe.entry_point == 0x68000 or  //5.20
	pe.entry_point == 0x3D000 or  //6.0
	pe.entry_point == 0x5A000 or  //6.2.4.624
	pe.entry_point == 0x62000 or  //6.40
	pe.entry_point == 0x68F85 or  //6.40 dll
...
rule packman10 {
	meta:
		...
		date = "2015-11"
	strings:
		$c0 = { 60 E8 00 00 00 00 5B 8D 5B C6 01 1B 8B 13 8D 73 14 6A 08 59 01 16 AD 49 75 FA 8B E8 C6 06 E9 8B 43 0C 89 46 01 6A 04 68 00 10 00 00 FF 73 08 51 FF 55 08 8B }
	condition:
		$c0 at pe.entry_point
}	
